...
export default function CosplayContest() {
  return (
    <>
      <Title heading="コスプレイベント" headingEnglish="Cosplay Event" />
      <div>
        ...
        <div className={styles.textbox}>
          <p>
            ...
            <br />
            勝敗を決めるのは審査員ではなく、
            <span className={styles.highlight}>会場のあなたの一票！</span>
            <br />
            参加者の魅力を見逃さず、ぜひ投票で盛り上げてください！
            <br />
            優勝者には<span className={styles.highlight}>豪華景品</span>
            をご用意！見るだけでも楽しめる、
            <br />
        ...
        <div className={styles.form_link}>
          <a href="https://docs.google.com/forms/d/e/1FAIpQLScOvKlPFdLcEpKyfXEOcwVFdcpuWxW8Tudtq020oLcUMHGQBg/viewform?usp=header">
            参加したい人はこちらをクリック
          </a>
        </div>
      </div>
